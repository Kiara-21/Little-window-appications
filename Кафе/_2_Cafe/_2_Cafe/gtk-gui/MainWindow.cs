...
public partial class MainWindow
{
	...
	protected virtual void Build()
	{
		...
		this.checkbutton1.Label = global::Mono.Unix.Catalog.GetString("Мясо (10грн)");
		...
		this.checkbutton2.Label = global::Mono.Unix.Catalog.GetString("Салат (20грн)");
		this.checkbutton2.DrawIndicator = true;
		this.checkbutton2.UseUnderline = true;
		this.fixed1.Add(this.checkbutton2);
		global::Gtk.Fixed.FixedChild w2 = ((global::Gtk.Fixed.FixedChild)(this.fixed1[this.checkbutton2]));
		w2.X = 45;
		w2.Y = 98;
		// Container child fixed1.Gtk.Fixed+FixedChild
		...
		this.checkbutton3.Label = global::Mono.Unix.Catalog.GetString("Фрукты (7грн)");
		this.checkbutton3.DrawIndicator = true;
		this.checkbutton3.UseUnderline = true;
		this.fixed1.Add(this.checkbutton3);
		global::Gtk.Fixed.FixedChild w3 = ((global::Gtk.Fixed.FixedChild)(this.fixed1[this.checkbutton3]));
		w3.X = 46;
		w3.Y = 132;
		// Container child fixed1.Gtk.Fixed+FixedChild
		...
		this.checkbutton4.Label = global::Mono.Unix.Catalog.GetString("Лимонад (5грн)");
		this.checkbutton4.DrawIndicator = true;
		this.checkbutton4.UseUnderline = true;
		this.fixed1.Add(this.checkbutton4);
		global::Gtk.Fixed.FixedChild w4 = ((global::Gtk.Fixed.FixedChild)(this.fixed1[this.checkbutton4]));
		w4.X = 46;
		w4.Y = 168;
		// Container child fixed1.Gtk.Fixed+FixedChild
		...
		this.label1.LabelProp = global::Mono.Unix.Catalog.GetString("Выберите блюда для заказа");
